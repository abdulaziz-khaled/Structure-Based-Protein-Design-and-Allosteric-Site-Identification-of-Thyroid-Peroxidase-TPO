...
**Via `SAVES Server`, `MOE`, and `PyMol`** 
...
![image](https://github.com/abdulaziz-khaled/Structure-Based-Protein-Design-and-Allosteric-Site-Identification-of-Thyroid-Peroxidase-TPO/blob/main/IMG_4315.jpeg)
![image](https://github.com/abdulaziz-khaled/Structure-Based-Protein-Design-and-Allosteric-Site-Identification-of-Thyroid-Peroxidase-TPO/blob/main/IMG_4318.jpeg)
...
# 1. Hide all distracting details and show a smooth cartoon representation
hide all
show cartoon, all
...
# 4. Enable transparency to completely remove the background
bg_color white
set ray_opaque_background, 0

# 5. Adjust lighting and remove distracting shadows
set ray_shadow, 0
set orthoscopic, on
...
Following the finalization of the 3D structure, the identification of a prospective allosteric binding pocket was conducted using the **Autochem agent v1** on the [**PAULING.AI**](https://www.pauling.ai/) platform. 

![image](https://github.com/abdulaziz-khaled/Structure-Based-Protein-Design-and-Allosteric-Site-Identification-of-Thyroid-Peroxidase-TPO/blob/main/phonto.png)

The objective was to locate a well-defined cavity distinct from the primary orthosteric active site, specifically targeting regions capable of allosteric communication and conformational control.
